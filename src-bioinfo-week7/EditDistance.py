...
class graph:
    ...
    def computeScores(self):
        ...
        i = 1
        while i < self.n + 1:
            nodes[i][0].weight = nodes[i-1][0].weight + 1 
        ...
        while i < self.n + 1:
            ...
            while j < self.m + 1:
                ...
                nodes[i][j].weight = min(up, left, diag)
...
class EditDistance:
    ...
    def __init__(self):
        ...
        Constructor
        '''
        self.dataSet = "dataset_77_3.txt"
        #self.testSet = "lcs.txt"
        self.testSet = "edit_distance.txt"
    ...
    def autoRun(self, f):
        ...
        from EditDistance import graph
