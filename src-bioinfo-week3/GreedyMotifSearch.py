...
class GreedyMotifSearch:
    ...
    def findBestProfile(self):
        ...
        for motif in self.DNAkmers[0]:
            ...
            while i < self.t:
                ...
                #print motif
                #print testProfile
                mostProbable = self.findMostProbable(self.DNAkmers[i], testProfile)
    ...
    def findMostProbable(self, kmers, profile):
        mostProb = kmers[0]
        probMostProb = self.probability(mostProb, profile)
        for k in kmers:
            contender = self.probability(k, profile)
